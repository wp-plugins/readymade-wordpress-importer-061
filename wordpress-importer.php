...
function wordpress_importer_init() {
	...
	register_importer( 'wordpress', 'ReadyMade WordPress Importer', __('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'wordpress-importer'), array( $GLOBALS['wp_import'], 'dispatch' ) );
}
